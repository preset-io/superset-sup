...
Key Features:
- Git-ready folder structure: sync_config"
---
...
| Command | Description |
|---------|-------------|
| `run` | Run a multi-target sync operation |
| `create` | Create a new sync configuration folder with example config |
| `validate` | Validate a sync configuration folder |
